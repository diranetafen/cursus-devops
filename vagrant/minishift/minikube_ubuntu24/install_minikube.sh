#!/bin/bash
VERSION_STRING="5:28.5.0-1~ubuntu.24.04~noble"
ENABLE_ZSH=true
...
# Configuration du dépôt pour Kubernetes 1.33
echo 
echo "[INFO] Configuration du dépôt pour Kubernetes 1.33"
echo
...
echo
minikube start --kubernetes-version v1.33.0 --driver=none
